...
cv::Mat cube::drawcube(cv::Mat frame, cv::Mat intrinsic_matrix, cv::Mat distortion_parameters, cv::Mat rvecs, cv::Mat tvecs)
{
	...
	line(frame, cube_img_pts[0], cube_img_pts[1], Scalar(0,0,255));
	line(frame, cube_img_pts[1], cube_img_pts[2], Scalar(0,0,255));
	line(frame, cube_img_pts[2], cube_img_pts[3], Scalar(0,0,255));
	line(frame, cube_img_pts[3], cube_img_pts[0], Scalar(0,0,255));
	line(frame, cube_img_pts[0], cube_img_pts[4], Scalar(0,0,255));
	line(frame, cube_img_pts[1], cube_img_pts[5], Scalar(0,0,255));
	line(frame, cube_img_pts[2], cube_img_pts[6], Scalar(0,0,255));
	line(frame, cube_img_pts[3], cube_img_pts[7], Scalar(0,0,255));
	line(frame, cube_img_pts[4], cube_img_pts[5], Scalar(0,0,255));
	line(frame, cube_img_pts[5], cube_img_pts[6], Scalar(0,0,255));
	line(frame, cube_img_pts[6], cube_img_pts[7], Scalar(0,0,255));
	line(frame, cube_img_pts[7], cube_img_pts[4], Scalar(0,0,255));
	return frame;
}
//**********************************************************************************************************************************************************************
